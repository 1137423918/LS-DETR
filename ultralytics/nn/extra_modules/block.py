...
__all__ = ['Ghost_HGBlock', 'Rep_HGBlock', 'DWRC3', 'C3_DWR', 'C2f_DWR', 'BasicBlock_Ortho', 'BottleNeck_Ortho',
           ...
           'BasicBlock_Faster_Block_EMA', 'BasicBlock_Faster_Block_Rep_EMA_CGLU', 'BottleNeck_Faster_Block_EMA', 'BasicBlock_Faster_Block_Rep', 'BasicBlock_Faster_Block_EMA_CGLU', 'BottleNeck_Faster_Block_Rep', 'BasicBlock_Faster_Block_Rep_EMA', 'BottleNeck_Faster_Block_Rep_EMA',
           ...
           'DynamicAlignFusion', 'CSP_MutilScaleEdgeInformationEnhance', 'C2f_FFCM'
           ]
...
class BasicBlock_Faster_Block_EMA_CGLU(BasicBlock):
    def __init__(self, ch_in, ch_out, stride, shortcut, act='relu', variant='d'):
        super().__init__(ch_in, ch_out, stride, shortcut, act, variant)
        
        self.branch2b = Faster_Block_EMA_CGLU(ch_out, ch_out)
